...
global.channelLink = "https://whatsapp.com/channel/0029VbBYGEB7tkjIMp1ljJ1K";
global.ytch = "DEMON KING TECH";
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.weather'):
                ...
                if (city) {
                    ...
                    await sock.sendMessage(chatId, { text: 'Please specify a city, e.g., .weather Cameroon', ...channelInfo });
                }
                break;
